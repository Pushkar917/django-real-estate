...
class Property(TimeStampedUUIDModel):
    ...
    ref_code = models.CharField(verbose_name=_("Property Refrence Code"), max_length=255, unique=True, blank=True)
    ...
    postal_code = models.CharField(verbose_name=_("Postal code"), max_length=100, default="560068")
    street_address = models.CharField(verbose_name=_("Street Address"), max_length=150, default="Silver County Road")
